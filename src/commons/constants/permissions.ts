...
export const PERMISSION = {
  ...
  ARENA_VIEW: `${RESOURCES.ARENA}:${ACTIONS.VIEW}`,
  ...
  WEBHOOK_VIEW: `${RESOURCES.WEBHOOK}:${ACTIONS.VIEW}`,
  WEBHOOK_MANAGE: `${RESOURCES.WEBHOOK}:${ACTIONS.MANAGE}`,
  SCHEDULE_VIEW: `${RESOURCES.SCHEDULE}:${ACTIONS.VIEW}`,
  ...
  SCANNER_VIEW: `${RESOURCES.SCANNER}:${ACTIONS.VIEW}`,
  ...
  WORKSPACE_SETTINGS_MANAGE: `${RESOURCES.WORKSPACE}:${ACTIONS.SETTINGS}`,
...
export const PERMISSION_DEFINITIONS: {
  ...
  {
    name: PERMISSION.ARENA_VIEW,
    resource: RESOURCES.ARENA,
    action: ACTIONS.VIEW,
    description: "View AI comparison runs",
  },
  {
  ...
  {
    name: PERMISSION.WEBHOOK_VIEW,
    resource: RESOURCES.WEBHOOK,
    action: ACTIONS.VIEW,
    description: "View outgoing webhook configuration and delivery history",
  },
  {
  ...
  {
    name: PERMISSION.SCHEDULE_VIEW,
    resource: RESOURCES.SCHEDULE,
    action: ACTIONS.VIEW,
    description: "View recurring scan schedules",
  },
  {
  ...
  {
    name: PERMISSION.SCANNER_VIEW,
    resource: RESOURCES.SCANNER,
    action: ACTIONS.VIEW,
    description: "View scanner engines and their status",
  },
  {
  ...
  {
    name: PERMISSION.WORKSPACE_SETTINGS_MANAGE,
