  ...
  return (
    <QueryProvider>
      <ConfigProvider theme={{ token: { colorPrimary: '#0f766e' } }}>
        <section style={{ minHeight: '100vh', background: '#f8fafb' }}>
          <div style={{ display: 'grid', minHeight: '100vh', gridTemplateColumns: '1fr 1fr' }}>
            {/* Left panel */}
            <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', background: '#0f766e', padding: '40px 56px', color: '#fff' }}>
